#!/usr/bin/env bash
# Assemble the hub site into _site/ from the three project sites.
#
#   scripts/build.sh [NFL_DOCS] [MADNESS_DOCS] [FINANCE_SITE]
#
...
finance="${3:-finance-quant/site}"

for d in "$nfl" "$madness" "$finance"; do
